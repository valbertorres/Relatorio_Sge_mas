...
public class GerarRelatorio {
	...
	private String str = "D:/Eclips Mars/workspace/Relatorio/src/main/java/com/interesys/sistema/relatorio_pedido.jasper";
	...
	public void imprimirRelatorio() throws Exception {
		...
		try {
			...
			JasperPrint jasperPrint = JasperFillManager.fillReport(str, this.parameters, jre);
